...
const QString BorderButtonK = "QPushButton { border: 1px solid black}";
...
const  QString mes7 = "Убедитесь, что датчик KS2 PROP1 подключен к компьютеру. Если датчик подключен, нажмите кнопку Диагностика.";
...
const  QString mes12 = "Калибровка предназначена для установки значений пустого и полного бака. "
                       "Калибровка увеличивает точность показаний датчика, так как за нулевое и максимальное значение принимаются параметры, рассчитанные исходя из характеристик конкретного бака.";
